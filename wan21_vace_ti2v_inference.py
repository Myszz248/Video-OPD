...
"""Run Wan2.1 VACE text-and-image-to-video inference with optional VACE LoRA."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Wan2.1 VACE text-and-image-to-video inference with optional VACE LoRA."
    )
    parser.add_argument(
        "--base-model",
        type=str,
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="VACE conditioning scale for the first-frame control input.",
    )
    parser.add_argument(
        "--flow-shift",
        type=float,
...
def main() -> None:
    """Run Wan2.1 VACE TI2V inference and save the result."""
    args = parse_args()
    ...
    metadata_path = save_metadata(
        build_metadata(args, output_path, image_path, lora_path),
        output_path,
    )
